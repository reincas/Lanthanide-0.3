...
# Modified 2001 by Reinhard Caspary <r.caspary@tu-bs.de>
# (To find the modifications, compare to original file Simplex.py.orig)
# 
            ...
            if T <= epsilon:   # We converged!  Break out of loop!
                ...
                if self.currenterror < self.errors[self.lowest]:
                    ...
                    if self.currenterror < tmp:
                        ...
                        self.currenterror = tmp ## inserted by RC
