...
Important: If you want to avoid the repeated calculation of all required matrices,
you should  place a symbolic link to the folder 'matrix' in each of your working directories.
